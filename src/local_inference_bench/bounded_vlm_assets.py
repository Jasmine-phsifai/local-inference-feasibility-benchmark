...
_CANDIDATE_CONTRACTS = {
    "ovisocr2_q8_cpu": {
        ...
        "quality_gate": {
            ...
            "minimum_lexical_recall": "unit_interval",
            "minimum_lexical_precision": "unit_interval",
            "minimum_table_cell_exact_fraction": "unit_interval",
        },
    ...
    "hunyuanocr_1_5_gguf_cpu": {
        ...
        "quality_gate": {
            "maximum_failure_count": "nonnegative_integer",
            "maximum_token_cap_hit_count": "nonnegative_integer",
            "maximum_normalized_character_error_rate": "unit_interval",
            "minimum_required_token_recall": "unit_interval",
            "maximum_negative_false_positive_characters": "nonnegative_integer",
        },
